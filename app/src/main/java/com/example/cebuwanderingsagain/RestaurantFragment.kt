...
class RestaurantFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        if (Places.getRestaurantPlaces().isEmpty()) {
            Places.addRestaurantPlace(Place("Greg Mar Arsua", 123, R.drawable.one))
            Places.addRestaurantPlace(Place("lloyd Pagobo", 321, R.drawable.two))
            Places.addRestaurantPlace(Place("Magdadaro", 234, R.drawable.three))
        }
